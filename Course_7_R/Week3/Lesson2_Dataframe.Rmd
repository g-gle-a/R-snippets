...
```{r}
names <- c("Gerardo", "Gerardo Jr", "Gerardo Alexandre", "Rosita")
```
...
```{r}
fruits <- c("Banana","Manga", "Morango", "Pêra", "Maça")
...
```{r}
fruis_ranged <- data.frame (fruits, range_fruits)
